...
public class GoJson2ClientCodegen extends AbstractGoCodegen {

    private final Logger LOGGER = LoggerFactory.getLogger(GoJson2ClientCodegen.class);
    ...
    public GoJson2ClientCodegen() {
        ...
        outputFolder = "generated-code/go-json2";
        embeddedTemplateDir = templateDir = "go-json2";
